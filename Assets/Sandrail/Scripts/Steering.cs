...
public class Steering : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		relativeVelocity = transform.InverseTransformDirection (transform.GetComponent<Rigidbody>().velocity).z;
		...
		steeringWheel.localRotation = Quaternion.Euler (0.0f, inputValue * steeringSensitivity, 0.0f);
	}
}
